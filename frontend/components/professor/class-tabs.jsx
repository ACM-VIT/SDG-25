    ...
    <Card className="p-6">
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-6">
        <div>
          ...
          <p className="text-3xl font-bold text-blue-600">{classData.students?.length || 0}</p>
        </div>
        <div>
          <p className="text-gray-600 text-sm mb-2">Class Code</p>
          <div className="flex items-center gap-2">
            <p className="text-2xl font-mono font-bold text-gray-800">{classData.code}</p>
            <button
              onClick={copyCode}
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
        <p className="text-sm text-gray-700">
          <strong>Share this code with your students</strong> so they can join your class. 
          Students can enter this code in the "Join Class" section.
        </p>
      </div>
      
      {classData.students && classData.students.length > 0 && (
        <div className="mt-6">
          <h3 className="text-lg font-bold text-gray-800 mb-3">Enrolled Students</h3>
          <div className="space-y-2">
            {classData.students.map((studentId, index) => (
              <div key={studentId} className="flex items-center gap-3 p-3 bg-gray-50 rounded">
